...
heatmap.2(similarity,
          ...
          #col = colorRampPalette(c("blue", "white", "red", "orange", "black", "pink"))(10000),  # Define color palette
          col= blues9,
          scale = "none",  # Don't scale the values
          main = "",  # Set main title
          xlab = "Sample", ylab = "Sample",  # Set axis labels
          ...
          notecex = 1  # Adjust size of correlation values
)
